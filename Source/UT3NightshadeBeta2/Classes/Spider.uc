...
defaultproperties
{
	...
	// Sound.
	ExplosionSnd(0) = Sound'UT3NightshadeBeta2.SpiderSounds.Spider_Explode01';
	ExplosionSnd(1) = Sound'UT3NightshadeBeta2.SpiderSounds.Spider_Explode02';
	ExplosionSnd(2) = Sound'UT3NightshadeBeta2.SpiderSounds.Spider_Explode03';
	AttackScreechSnd(0) = Sound'UT3NightshadeBeta2.SpiderSounds.Spider_Attack01';
	AttackScreechSnd(1) = Sound'UT3NightshadeBeta2.SpiderSounds.Spider_Attack02';
	AttackScreechSnd(2) = Sound'UT3NightshadeBeta2.SpiderSounds.Spider_Attack03';
	WalkingSnd(0) = Sound'UT3NightshadeBeta2.SpiderSounds.Spider_Walk01';
	WalkingSnd(1) = Sound'UT3NightshadeBeta2.SpiderSounds.Spider_Walk02';
	WalkingSnd(2) = Sound'UT3NightshadeBeta2.SpiderSounds.Spider_Walk03';
}
