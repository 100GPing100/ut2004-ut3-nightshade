	...
	if (CurrentState == VS_Deployed)
	{
		switch (SelectedMine)
		{
			case 1:
				...
				SelectedMine = 2;
				PlaySound(Sound'UT3NightshadeBeta2.Sounds.SwitchDeployable', SLOT_None);
...
DefaultProperties
{
	...
	// Sound.
	IdleSound = Sound'UT3NightshadeBeta2.Sounds.Engine';
	StartUpSound = Sound'UT3NightshadeBeta2.Sounds.EngineStart';
	ShutDownSound = Sound'UT3NightshadeBeta2.Sounds.EngineStop';
	DeploySnd = Sound'UT3NightshadeBeta2.Sounds.ArmExtend';
	UndeploySnd = Sound'UT3NightshadeBeta2.Sounds.ArmRetract';
	SwitchDeployableSnd = Sound'UT3NightshadeBeta2.Sounds.SwitchDeployable';
	DropItemSnd = Sound'UT3NightshadeBeta2.Sounds.DropItem';
	MaxPitchSpeed = 1250; // 1000
	ImpactDamageSounds(0) = Sound'UT3NightshadeBeta2.Sounds.Impact01';
	ImpactDamageSounds(1) = Sound'UT3NightshadeBeta2.Sounds.Impact02';
	ImpactDamageSounds(2) = Sound'UT3NightshadeBeta2.Sounds.Impact01';
	ImpactDamageSounds(3) = Sound'UT3NightshadeBeta2.Sounds.Impact02';
	ImpactDamageSounds(4) = Sound'UT3NightshadeBeta2.Sounds.Impact01';
	ImpactDamageSounds(5) = Sound'UT3NightshadeBeta2.Sounds.Impact02';
	ImpactDamageSounds(6) = Sound'UT3NightshadeBeta2.Sounds.Impact01';
