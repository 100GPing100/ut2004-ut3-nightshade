...
DefaultProperties
{
	...
	// Sound.
	ActivateSnd(0) = Sound'UT3NightshadeBeta2.SpiderSounds.SpiderMine_Active01';
	ActivateSnd(1) = Sound'UT3NightshadeBeta2.SpiderSounds.SpiderMine_Active02';
	ActivateSnd(2) = Sound'UT3NightshadeBeta2.SpiderSounds.SpiderMine_Active03';
	DropSnd = Sound'UT3NightshadeBeta2.SpiderSounds.SpiderMine_Drop';
