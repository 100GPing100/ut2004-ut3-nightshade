//============================================================
// Spider (spiders that spawn with the spider mine).
...
function AcquireTarget()
{
	...
	/*if ( xPawn(TargetPawn) != None )
	{
		xPawn(TargetPawn).AddSpiderChaser(self);
	}*/
	WarnTarget(); // Maybe this?
}
...
simulated state OnGround
{
	...
	function ReturnToTrap()
	{
		...
		{
			Level.Game.BroadCast(Lifeline.Controller, "Fuck yeah!", 'Say');
			GotoState('Returning');
		}
	}
	...
	function bool SetScurryTarget(vector NewTargetLoc, Pawn NewInstigator)
	{
		...
		if (bResult && !ReturnToTrapEnabled)
		{
			...
			Level.Game.BroadCast(Lifeline.Controller, "On no!", 'Say');
	...
	function Tick(float DeltaTime)
	{
		...
		{
			Level.Game.BroadCast(Lifeline.Controller, "Yup.", 'Say');
			ReturnToTrapEnabled = false;
			ReturnToTrap();
		}
	}
...
defaultproperties
{
	...
	// Sound.
	ExplosionSnd(0) = Sound'UT3NightshadeBeta1.SpiderSounds.Spider_Explode01';
	ExplosionSnd(1) = Sound'UT3NightshadeBeta1.SpiderSounds.Spider_Explode02';
	ExplosionSnd(2) = Sound'UT3NightshadeBeta1.SpiderSounds.Spider_Explode03';
	AttackScreechSnd(0) = Sound'UT3NightshadeBeta1.SpiderSounds.Spider_Attack01';
	AttackScreechSnd(1) = Sound'UT3NightshadeBeta1.SpiderSounds.Spider_Attack02';
	AttackScreechSnd(2) = Sound'UT3NightshadeBeta1.SpiderSounds.Spider_Attack03';
	WalkingSnd(0) = Sound'UT3NightshadeBeta1.SpiderSounds.Spider_Walk01';
	WalkingSnd(1) = Sound'UT3NightshadeBeta1.SpiderSounds.Spider_Walk02';
	WalkingSnd(2) = Sound'UT3NightshadeBeta1.SpiderSounds.Spider_Walk03';
}
